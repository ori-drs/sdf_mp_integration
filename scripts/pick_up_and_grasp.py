...
if __name__ == '__main__':
    ...
    whole_body.move_end_effector_pose(geometry.pose(z=0.15), whole_body.end_effector_frame)
    gripper.apply_force(0.5)
    rospy.sleep(1.0)
    whole_body.move_to_joint_positions({"arm_lift_joint": 0.23})
    rospy.sleep(1.0)
    whole_body.move_end_effector_pose(geometry.pose(z=-0.25), whole_body.end_effector_frame)
