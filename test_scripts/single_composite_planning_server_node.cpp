...
int main(int argc, char **argv) {
    ...
    sdf_mp_integration::PlanningServer<gpu_voxels_ros::SingleCompositeSDF*>* planning_server_ptr; 
    ...
    planning_server_ptr = new sdf_mp_integration::PlanningServer<gpu_voxels_ros::SingleCompositeSDF*>(nh);
